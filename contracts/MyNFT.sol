...
contract MyNFT is ERC721Enumerable, Ownable {
    ...
    function mint(
        ...
        bytes32 message =
            ECDSA.toEthSignedMessageHash(
                keccak256(abi.encode(_toAddress, _tokenId, _timestamp))
            );
        require(message.recover(_sig) == owner(), "Error, transaction must be authorized by contract owner");
    ...
    function buyAndMint(
        ...
        mint(_tokenId, _tokenURI, msg.sender, _price, _timestamp, _sig);
